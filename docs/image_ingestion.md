...
- **Model:** `FIREWORKS_VISION_MODEL` (fallback: `FIREWORKS_MODEL`, then `accounts/fireworks/models/kimi-k2p5` per [Fireworks vision guide](https://docs.fireworks.ai/guides/querying-vision-language-models))
